...
// Appended to every agent's system prompt — enforces THB-first currency display and no fabricated amounts
...
อัตรา: ใช้อัตราแลกเปลี่ยน USD/THB ปัจจุบัน (ถ้าไม่ทราบใช้ประมาณ 35 บาท/$)
ข้อยกเว้น: ราคาต่อหุ้น/เหรียญเดียว (SPY $587.23) ใช้ $ ได้ตามปกติ แต่ถ้าเป็นยอดเงินไม่ว่าจะซื้อเท่าไร ต้องแสดงบาทด้วย

## กฎห้ามเดายอดเงิน (บังคับ ห้ามฝ่าฝืน)
ถ้าพอร์ตไม่ได้ระบุยอดเงินลงทุนรวม (total capital) — ห้ามสมมติหรือแต่งตัวเลขขึ้นมาเอง
ให้แนะนำเป็น % หรือ "สัดส่วน" เท่านั้น เช่น "35% ใน SPY" ไม่ใช่ "฿367,500 ใน SPY"
ถ้าผู้ใช้ระบุงบมา (เช่น "มีเงิน 10,000 บาท") ถึงจะคำนวณยอดจริงได้`;
